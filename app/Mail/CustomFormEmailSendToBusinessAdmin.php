...
class CustomFormEmailSendToBusinessAdmin extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->cc($salitse_email)
                    ...
                    ->subject('NEW SUBMISSION GET A QUOTE BY '.ucfirst($client->firstname))
                    ->view('emails.custom_email_to_business_admin');
    }
}
