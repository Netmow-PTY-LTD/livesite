		...
		<div style="background-color: #FCFCFC;width: 800px;margin: 0 auto;">
			<div style="width: 640px; margin: 0 auto;">
				...
				<div style="width: 100%; margin: 0 auto;text-align: center;padding: 10px 0;background-color: {{ $LiveSiteStyle->action_background_color }};">
					<h2 style="font-family: Arial;font-size: 22px;font-weight: 600;color: #ffffff;margin: 0;line-height: 1;">New document share</h2>
				</div>
				<div style="width: 100%; margin: 0 auto;text-align: center;background-color: #ffffff;">
					<div style="margin: 0 auto;text-align: center;padding: 20px 0 15px;">
						<p style="font-family: Arial;font-size: 14px;color: #333333;text-align:left;padding-left:30px;font-weight: 600;margin: 0;padding-bottom: 5px;">Dear {{ ucfirst($business->business_name)}},</p>
						<p style="font-family: Arial;font-size: 12px;font-weight: 400;line-height: 17px;color: #818181;text-align:left;padding-left:30px;;margin: 0;">A new document was shared with you by <a href="{{config('app.apps_url')}}/app/{{ $business->uid }}/validate?business_token={{ $live_site_token->token }}" class="jhonlink" style="color: {{ $LiveSiteStyle->action_background_color }};text-decoration: underline;">{{ucfirst($inbox->inbox_firstname)}} {{ ucfirst($inbox->inbox_lastname) }}.</a></p>
					</div>
					<div style="width: 400px; margin: 0 auto;text-align: center;padding: 20px;">
					    <p style="font-family: Arial;font-size: 12px;line-height: 17px;color: #818181;text-align: center;margin: 0;">Call {{ ucfirst($inbox->inbox_firstname)}} {{ucfirst($inbox->inbox_lastname) }} at the following number: {{ $inbox->inbox_phone }}</p>
					    <p style="font-family: Arial;font-size: 12px;line-height: 17px;color: #818181;text-align: center;margin: 0;text-decoration:none;font-size:15px;"><a style="text-decoration:none;" href="{{config('app.live_url')}}/images/client_document/{{ $client_document->client_file }}">View Docuement: {{ $client_document->client_document }}</a></p>
