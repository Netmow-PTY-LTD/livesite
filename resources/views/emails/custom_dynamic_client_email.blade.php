			...
			<div style="width: 640px; margin: 0 auto;">
				...
				<div style="width: 100%; margin: 0 auto;text-align: center;background-color: #ffffff;">
					<div style="margin: 0 auto;text-align: center;padding: 20px 0 15px;">
						...
						<p style="font-family: Arial;font-size: 12px;font-weight: 400;line-height: 17px;color: #818181;text-align:left;padding-left:30px;;margin: 0;">Please allow up to 24 hours for your Quote or further contact from us.We appreciate the opportunity and look forward to meeting you soon! 
				...
				<div style="width: 100%; margin: 15px auto 0;text-align: left;background-color: #ffffff;">
					<div style="width: 600px; margin: 0 auto;text-align: left;padding: 30px;">
						<h3 style="font-size: 15px;color: #3d3e44;margin: 0 0 20px;">Quote Details : </h3>
						<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
							<tbody>
								<tr>
									<th width="80" style="vertical-align: top;"><span style="font-family: Arial;font-size: 12px;line-height: 17px;color: #0E1130;">Full Name</span></th>
									<td width="250" style="vertical-align: top;">: <a style="padding-left: 5px;font-family: Arial;font-size: 14px;line-height: 17px;text-decoration: none;color: #818181; display: inline-block;">{{ ucfirst($inbox->inbox_firstname)}} {{ucfirst($inbox->inbox_lastname) }}</a></td>
								</tr>
								<tr>
				...
				<div style="width: 440px;margin: 0 auto;padding: 20px 0 0;text-align: center;">
					<div style="line-height: 1;">
						<a href="{{ $business_info->facebook ?? '#' }}"><img src="{{config('app.apps_url')}}/images/miyn_social_icon/fb_white.png" style="width:30px;height:30px;border-radius:50%;background-color: {{ $LiveSiteStyle->action_background_color }};" alt="f"></a>	
						<a href="{{ $business_info->linkdin ?? '#' }}"><img src="{{config('app.apps_url')}}/images/miyn_social_icon/linkedin_white.png" style="width:30px;height:30px;border-radius:50%;background-color: {{ $LiveSiteStyle->action_background_color }};" alt="l"></a>		
						<a href="{{ $business_info->twitter ?? '#' }}"><img src="{{config('app.apps_url')}}/images/miyn_social_icon/twitter_white.png" style="width:30px;height:30px;border-radius:50%;background-color: {{ $LiveSiteStyle->action_background_color }};" alt="t"></a>
						<a href="{{ $business_info->gmail ?? '#' }}"><img src="{{config('app.apps_url')}}/images/miyn_social_icon/insta_white.png" style="width:30px;height:30px;border-radius:50%;background-color: {{ $LiveSiteStyle->action_background_color }};" alt="i"></a>		
					</div>
