...
<html xmlns="http://www.w3.org/1999/xhtml">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
									<tbody>
										<tr>
											...
											<div style="widht:150px;margin:0 auto;">
											    <img src="{{ 'https://live.miyn.net/business_images/logo/MIYN-registratin_logo.png' }}">
											</div>
											<!-- } else { -->
	...
	<div style="line-height: 2;">Dear {{ ucfirst($client->firstname)." ".ucfirst($client->lastname) }}, </div>


	<div style="line-height: 2;">Thanks for your booking. Looking forward to meeting you! </div>
	<div style="line-height: 2;">Once {{ ucfirst($business->business_name) }} accepts the appointment you will get an email notification. </div>
	<!--<div style="line-height: 2;">Your appointment request has been received and your specified date and time(s) chosen was: </div>-->
											...
											<!--<div style="line-height: 2;">We are currently checking our schedule and will revert with confirmation ASAP. For urgent assistance, please call 1800 217 217. We look forward to speaking with you soon. Aylward Game.</div>-->
											<br>
											...
											<div style="text-align: center;">
											  <h3 style="width: 270px;height: 33px; background-color: #00b604; padding-top: 12px;border-radius: 5px; margin-left: 140px;">
											  	<a style="color:#fff;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;" href="https://miyn.net/login"> REPLY / VIEW ONLINE </a>
											  </h3>
											    <br>
											    <a style="color:#15c" href="https://miyn.net/login">Make changes</a>
											</div>
											<br>
