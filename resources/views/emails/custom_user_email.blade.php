							...
							<table align="left" bgcolor="#ffffff" width="100%" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;background-color: #ffffff;text-align: left;">
								<tbody>
									...
									<tr>
                                    	...
                                    	<div style="line-height: 2;color:#000000;">Dear {{ ucfirst($client->firstname)." ".ucfirst($client->lastname) }}, </div>
                                    
                                    	<div style="color:#000000;">All done! Thank you again for contacting First Class Functions! We are excited to get planning with you and will be back in touch asap. XOXO</div>

											<br>
											<hr>

											@if($inbox->limit_exceed_status === 1)

												<div style="color:#000000;"><b>First Class Functions</b></div>
	                            				<div style="color:#000000;">44 Rene St, Noosaville, Qld, 4566</div>

											@else

												<div style="color:#000000;"><b>First Class Functions</b></div>
	                            				<div style="color:#000000;">44 Rene St, Noosaville, Qld, 4566</div>
	                            				<div style="color:#000000;"><b>Email:</b>  info@firstclassfunctions.com.au</div>
	                            				<div style="color:#000000;"><b>Phone Number:</b> (07) 5474 0299</div>
	                            				<div style="color:#000000;"><b>Tel:</b> Number: 07 5474 0299</div>
