								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
									<tbody>
										<tr>
											...
											<div style="width: 150px;font-size: 20px;color: #ffffff;margin:0 auto;"><img src="{{ 'https://app.miyn.net/images/business_logo/'.$business_info->logo_image }}" alt="MIYN" style="width: 100%;"></div>        
											<!-- } -->
											</td>
										</tr>
									</tbody>
							...
							<table align="left" bgcolor="#ffffff" width="100%" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;background-color: #ffffff;text-align: left;">
								<tbody>
									...
									<tr>
                                    	...
                                    	<div style="line-height: 2;">Your greeting has been sent.  </div>
											...
											<div>Send Time: {{ $greeting->created_at->format('d/m/Y H:i') }}</div>
