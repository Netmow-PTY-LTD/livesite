								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;">
									<tbody>
										<tr>
											...
											<div style="width: 70px;height: 70px;font-size: 20px;color: #ffffff;line-height: 70px;margin:0 auto;border-radius: 50px;background-color: #4675d9;">{{ substr(ucfirst($business->business_name), 0, 1) }}</div>        
											<!-- } -->
											</td>
										</tr>
									</tbody>
							...
							<table align="left" bgcolor="#ffffff" width="100%" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;background-color: #ffffff;text-align: left;">
								<tbody>
									...
									<tr>
                                    	...
                                    	<div style="line-height: 2;">Dear {{ ucfirst($business->business_name) }}, </div>
                                    
                                    	<div style="line-height: 2;">You have a quote from {{ ucfirst($client->firstname)." ".ucfirst($client->lastname) }}
											
											
											<div style="text-align: center;">
											  <a style="color:#fff;" href="https://miyn.net/login"><h3 style="width: 270px;height: 30px;background-color: #26db28;padding-top: 5px;border-radius: 4px;margin-left:140px;">
											  	Login
											  </h3></a>
											    <a href="https://miyn.net/login">View Online</a>
											</div>
											<br>		
											...
											<div>Send Time: {{ $quote->created_at->format('d/m/Y H:i') }}</div>
											<div style="line-height: 2;">
											    Notes: {{ $quote->quote_note }}
											</div>
