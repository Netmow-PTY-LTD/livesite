...
<div id="myCtrl" ng-app="myApp" ng-controller="myCtrl"  style="width:700px; margin-left:auto; margin-right:auto; " ng-cloak>
				...
				<li ng-click="myFunc(serviceselecteds)"  class="ng-scope" ng-repeat="serviceselecteds in cateogoryseleted.service">
							<ul class="service-item">
								...
								<div class="icon ng-scope icon-phone2" >
								    ...
								    <img src="https://live.miyn.net/service_images/@{{serviceselecteds.imagepath}}" ng-if="serviceselecteds.isimage == 'true'"  />
...
function generate_series(step, offset, newoffset) {
   ...
   var htmlcolde  = "";
	...
	count++;
	var cstart = new Date(startYear, startMonth, startDate, startHour, startMin, 0), 
		  cend = new Date(startYear, startMonth, startDate, endHour, endMin, 0),
