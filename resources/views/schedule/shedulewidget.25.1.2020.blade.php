    				...
    				<ul class="miyn-popup-service-list">
    					<li class="miyn-popup-service-item ng-scope" ng-click="myFunc(serviceselecteds)"  class="ng-scope" ng-repeat="serviceselecteds in cateogoryseleted.service">
    						<div class="miyn-popup-service-icon">
    							<span><img src="{{config('app.live_url')}}/images/service/initial-advice.png" alt="icon"/></span>
    						</div>
    						...
    						<ul class="miyn-popup-staff-list">
    							<li class="miyn-popup-staff-item" ng-click="setStaff(staff)">
    								<div class="miyn-popup-user-image">
    									<img src="<?php echo $appurl ?>/images/staff/@{{ staff.staff_image == '' ? staff.staff_image = 'avatar.jpg' : staff.staff_image=staff.staff_image }}" alt="Jesse Pigdon"/>
    								</div>
        		...
        		<div class="fragment  active">
    				<div class="miyn-popup-navigation">
    					<ul>
    						...
    						<li><a onClick="staffSelect()()" href="#">2. Stuff</a></li>
					...
					<div class="miyn-popup-forms">
						<div class="miyn-popup-field-form name-field">
							<div class="miyn-popup-subfield-form">
								<input type="text"  name="c_first_name" id="c_first_name" placeholder="First name*" />
							</div>
							<div class="miyn-popup-subfield-form">
								<input type="text"  name="c_last_name" id="c_last_name" placeholder="Last name*" />
							</div>
						</div>
						...
						<div class="miyn-popup-field-form country-field">
							...
							<div class="miyn-popup-subfield-form">
								<input type="text" name="c_phone" id="c_phone"  placeholder="Phone Number*" />
							</div>
						</div>
						...
						<div class="form-submit-button">
							...
							<a class="miyn-popup-backbutton" href="#" onClick="formToShedule()">Back</a>
						</div>
					</div>
				</form>
			</div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                html += '<div class="miyn-popup-confirmation-content">';
					...
					html += '<p>You will receive an email once admin, confirm your booking</p>';
					html += '<div class="miynpopup-confirmation-booking-info">';
						html += '<p>Thanks for your booking, Looking forward to meeting you!</p>';
