...
<?php
    foreach($service_info as $keys=>$vals){ 
        foreach($vals->service as $key=>$val){ 
    ?>  
        <div id="select-user<?php echo $key; ?>" class="miyn-popup-user-selection-area miyn-iframe-popup-box">
            ...
            ?> 
    		    <li>
    				...
    				view_in_same_day="<?php echo $val->view_in_same_day; ?>" 
        ...
        ! function() {
            ...
            var _slot ={
                ...
                console_today_selected_date : function() {
                    ...
                    console.log('_this.today_date-'+_today.convert_date_time());
                    
                    /* Test Data */
                    var javaScriptRelease = new Date(_today.convert_date_time());
                    console.log(javaScriptRelease.setHours(24));
            		...
            		$(document).on('click', '.miyn-iframe-popup-box a', function(){
            			...
            			if(popID =="appointment-schedule") {
            			  ...
            			  if($(this).attr('data-item') !="Called") {
                			   ...
                			   _this.view_in_same_day       = $(this).attr('view_in_same_day');
                			   console.log('_this.view_in_same_day-'+_this.view_in_same_day);
                			   // Box's Data
