...
! function() {
    ...
    function MIYNLive(options) {}
       ...
       //var curr = window.location.protocol + "//" +  window.location.hostname;
        ...
        if(pathArray[2] == 'app.miyn.app') {
           curr_url = ""; 
        }
        
		 $.ajax({
            type: 'GET',
            url: protocl+apisite+'/api/business_info/'+_.uid+'?curr_url='+curr_url,
...
var _f ={
    ...
    custom_form : function (b_info) {
         $( document ).ready(function() {
    		...
    		f.src = protocl + livesite + "/customform/"+config.uid+"?"+_f.cluidparam;
    		f.frameBorder="0";
    ...
    send_file : function(b_info){    // _l.a()
        ...
        $( document ).ready(function() {
    		...
    		f.style.display = "block";
    		f.id="miyn-widgets-boxs-iframe";
    		f.src = protocl + livesite + "/new_send_file/"+config.uid+"?"+_f.cluidparam;
    		f.frameBorder="0";
    		$('#miyn_iframe_box .miyn-widget-iframe-contents-load').html(f);
    		...
    		f2.src = protocl + livesite + "/new_send_file/"+config.uid+"?"+_f.cluidparam;
    		f2.frameBorder="0";
        			...
        			wbin1 += '<div class="miyn-widgets-popup-inner-contents '+grbox+'" style="display:none;">'; //miyn-grid-layout
        				...
        				wbin1 += '<div class="miyn-widget-popup-services">';
        					...
        					wbin1 += '<ul>';
            					...
            					//}
            					wbin1 += '<li><a class=" bbutton '+prefix+'acc  miynacc-box openbox " dtbutton="acc" dtpopuptype="'+b_info.livestyle.button_bottom_open_box+'" href="#"><span><img src="https://'+livesite+'/images/rounded/my-acc.png" alt="schedule-icon.png"/></span>My Account</a></li>';
