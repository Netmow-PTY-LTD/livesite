...
! function() {
    ...
    _t.initEvent = function () {
		...
		$(document).on('click', '.miyn-widgets-footer-button-area .miyn-widget-popup-button', function(){
			...
			console.log('.miyn-widgets-footer-button-area .miyn-widget-popup-button');	
			// Box
            ...
            var wb1 = '<div id="widget_button_option_1" class="miyn-widget-buttons-area">';
    		    ...
    		    for (var i = 0; i < b_info.liveaction.length; i++) {
    		        if(b_info.liveaction[i].view_status == 'true') {
        			    wb1 += '<li><a class=" rbutton '+prefix+b_info.liveaction[i].calltoaction+' " dtbutton="'+b_info.liveaction[i].calltoaction+'" href="#"><img src="'+protocl+livesite+'/images/asset/'+b_info.liveaction[i].rounded_button_image+'" alt="schedule-icon.png"/><span>'+b_info.liveaction[i].calltoaction_text+'</span></a></li>';
    		        	this.SVGIcons(b_info.liveaction[i].calltoaction);
    		        }
    		    }
    		   ...
    		   // }
    		    ...
    		    wb1 += `<svg class="roundedicon-acc" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 87.65" style="enable-background:new 0 0 100 87.65;" xml:space="preserve">
<style type="text/css">
 svg.roundedicon-acc {
    width:20px;
    height:20px;
        			...
        			wbin1 += '<div class="miyn-widgets-popup-inner-contents '+grbox+'" style="display:none;">'; //miyn-grid-layout
        				...
        				if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        				    ...
        				    if(b_info.powered_by_text == null) {
        				        wbin1 += '<p>Driven by <a target="_blank" href="'+protocl+mainsite+'"><img class="miyn-popup-brand" src="'+protocl+cdnsite+'"/images/MIYN-popup-logo-120x30.png" /></a></p>';
        				    } else {
            ...
            wbin2 += '<div class="miyn-widgets-popup-inner-contents" style="display:none;">';
    			...
    			wbin2 += '<div class="miyn-widgets-popup-footer">';
    				    if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        		            ...
        		            if(b_info.powered_by_text == null) {
        				        wbin2 += '<p>Driven by <a target="_blank" href="'+protocl+mainsite+'"><img class="miyn-popup-brand" src="'+protocl+cdnsite+'/images/MIYN-popup-logo-120x30.png" /></a></p>';
        				    } else {
            ...
            wb3 += '<div class="miyn-widgets-popup-inner-contents" style="display:none;">';
    			...
    			wb3 += '<div class="miyn-widgets-popup-footer">';
    				    if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        		            ...
        		            if(b_info.powered_by_text == null) {
        				        wb3 += '<p>Driven by <a target="_blank" href="'+protocl+mainsite+'"><img class="miyn-popup-brand" src="'+protocl+cdnsite+'/images/MIYN-popup-logo-120x30.png" /></a></p>';
        				    } else {
