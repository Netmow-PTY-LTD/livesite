...
! function() {
                                ...
                                .then(text => {
                                  ...
                                  var infos = JSON.stringify(text);
                                    ...
                                    if(b_info.livestyle.chat_box == 'true') {
                                        ...
                                        document.querySelector("#widget_popup_option_2.miyn-widgets-footer-button-area").style.right = "100px";
                                    }

                                    //$("#widget_popup_option_2 a").css({"color": b_info.livestyle.action_text_color+"!important" });
                                    //document.querySelector("#widget_popup_option_2 a").style.color = b_info.livestyle.action_text_color+"!important";
                                    ...
                                    document.querySelector("#miyn_iframe_box.miyn-widget-popup-content-area .miyn-widgets-popup-inner-contents .miyn-popup-close-button").style.backgroundColor = ""+b_info.livestyle.action_background_color+"";
                                    ...
                                    if(!_.ui) {
                                        $("#widget_button_option_1").addClass('uihide');
                                        $("#widget_popup_option_2").addClass('uihide');
                                        $(".miyn-chat-link").addClass('uihide');
                                    }
    ...
    _Mi.eventLoop = function ()
    {
        ...
        */
                ...
                console.log("bbutton");
                    ...
                    if(_Mi.returniIframe()) {
                          ...
                          //  console.log(databutton);
                            ...
                            if(databutton == 'call') {
                                  document.querySelector('.miyn-widget-popup-button').style.display = "block";
        ...
        /*
        *  .rbutton
        *  All Rounded Button Events
        */

        //#region  rbutton

        var roundedbuttons = document.querySelectorAll('.rbutton_');
        for (let i = 0; i < roundedbuttons.length; ++i) {
            roundedbuttons[i].addEventListener('click', function (event) {
               ...
               // _$.hide('.miyn-widget-popup-content-area');
                //_$.show('.miyn-widget-popup-close-button');
                //_$.hide('#chatlink');
               ...
               if (databutton == 'file'){
                ...
                if (databutton == 'greeting'){
                    _f.greeting();
                }

                if (databutton == 'googlemap'){
                    _f.google_map();
                }
    ...
    _Mi.onTestChange = function (e) {
     ...
     _Mi.initEventList = function () {
        ...
        // });
            ...
            document.querySelectorAll(".miyn-file").forEach(el => {
                el.addEventListener('click',function (e) {
                    var popID = "miyn_iframe_box";
                    _$.show('#'+popID);
                    _$.appendTo('#'+popID+' > .miyn-widget-iframe-contents-load', '');
            ...
            document.querySelectorAll(".miyn-quote").forEach(el => {
                el.addEventListener('click',function (e) {
                    var popID = "miyn_iframe_box";
                    _$.show('#'+popID);
                    _$.appendTo('#'+popID+' > .miyn-widget-iframe-contents-load', '');
            ...
            document.querySelectorAll(".miyn-greeting").forEach(el => {
                el.addEventListener('click',function (e) {
                    var popID = "miyn_iframe_box";
                    _$.show('#'+popID);
                    _$.appendTo('#'+popID+' > .miyn-widget-iframe-contents-load', '');
            ...
            document.querySelectorAll(".miyn-googlemap").forEach(el => {
                el.addEventListener('click',function (e) {
                    var popID = "miyn_iframe_box";
                    _$.show('#'+popID);
                    _$.appendTo('#'+popID+' > .miyn-widget-iframe-contents-load', '');
            ...
            document.querySelectorAll(".miyn-acc").forEach(el => {
                el.addEventListener('click',function (e) {
                    var popID = "miyn_iframe_box";
                    _$.show('#'+popID);
                    _$.appendTo('#'+popID+' > .miyn-widget-iframe-contents-load', '');
            ...
            document.querySelectorAll(".miyn-chat").forEach(el => {
                el.addEventListener('click',function (e) {
                    var popID = "miyn_iframe_box";
                    _$.show('#'+popID);
                    _$.appendTo('#'+popID+' > .miyn-widget-iframe-contents-load', '');
        ...
        // document.querySelector('.miyncustomform').addEventListener('click', function (event) {
        //     var popID = "miyn_iframe_box";
        //     _$.show('#'+popID);
        //     _$.appendTo('#'+popID+' > .miyn-widget-iframe-contents-load', '');
        //     _f.custom_form();
        ...
        // }),
            ...
            /*document.querySelectorAll(".miyn-popup-close-button").forEach(el => {
                el.addEventListener('click',function (e) {
                    _$.hide('#miyn_iframe_box');
                    _$.show('#chatlink');
                    return false;
...
// Window
   ...
   /* $(window).on("blur focus", function(e) {
	...
	window.addEventListener('load',function(event)
	{
	    ...
	    let  link_url =  "https://test3.miyn.app/newdesign/css/style.css" ;
