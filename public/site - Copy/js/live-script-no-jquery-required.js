...
! function() {
    ...
    _Mi.uidesign = function(b_info, _) {
        ...
        if(e14){
            _$.addStyle(e14, {"background-color": ""+b_info.livestyle.action_text_color+""});
        }

        var e15 = "#widget_popup_option_2 .miyn-grid-layout .miyn-widget-popup-header-content p";
        if(e15){
            _$.addStyle(e15, {"background-color": ""+b_info.livestyle.action_text_color+""});
        }
        ...
        if(!_.ui) {                 
            ...
            document.querySelector("#widget_button_option_1").classList.add("uihide");
            document.querySelector("#widget_popup_option_2").classList.add("uihide");
            document.querySelector(".miyn-chat-link").classList.add("uihide");
