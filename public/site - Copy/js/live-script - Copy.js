            ...
            var wb1 = '<div id="widget_button_option_1" class="miyn-widget-buttons-area">';
    		    ...
    		    for (var i = 0; i < b_info.liveaction.length; i++) {
    		        if(b_info.liveaction[i].view_status == 'true') {
        			    wb1 += '<li><a class=" rbutton '+prefix+b_info.liveaction[i].calltoaction+' " dtbutton="'+b_info.liveaction[i].calltoaction+'" href="#"><img src="'+protocl+livesite+'/images/rounded/'+b_info.liveaction[i].rounded_button_image+'" alt="schedule-icon.png"/><span>'+b_info.liveaction[i].calltoaction_text+'</span></a></li>';
    		        }
    		    }
    		   ...
    		   // }
    		    ...
    		    wb1 += '<li><a class=" rbutton '+prefix+'acc" dtbutton="acc" href="#miyn_iframe_box"><img src="'+protocl+livesite+'/images/rounded/my-acc.png" alt="schedule-icon.png"/><span>My Account</span></a></li>';
        			...
        			wbin1 += '<div class="miyn-widgets-popup-inner-contents '+grbox+'" style="display:none;">'; //miyn-grid-layout
        				...
        				wbin1 += '<div class="miyn-widget-popup-services">';
        					...
        					wbin1 += '<ul>';
            					...
            					//}
            					wbin1 += '<li><a class=" bbutton '+prefix+'acc  miynacc-box openbox " dtbutton="acc" dtpopuptype="'+b_info.livestyle.button_bottom_open_box+'" href="#"><span><img src="'+protocl+livesite+'/images/rounded/my-acc.png" alt="schedule-icon.png"/></span>My Account</a></li>';
        				...
        				if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        				    ...
        				    if(b_info.powered_by_text == null) {
        				        wbin1 += '<p>Driven by <a target="_blank" href="'+mainsite+'"><img class="miyn-popup-brand" src="'+protocl+cdnsite+'"/images/MIYN-popup-logo-120x30.png" /></a></p>';
        				    } else {
            ...
            wbin2 += '<div class="miyn-widgets-popup-inner-contents" style="display:none;">';
    			...
    			wbin2 += '<div class="miyn-widgets-popup-footer">';
    				    if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        		            ...
        		            if(b_info.powered_by_text == null) {
        				        wbin2 += '<p>Driven by <a target="_blank" href="'+mainsite+'"><img class="miyn-popup-brand" src="'+protocl+cdnsite+'/images/MIYN-popup-logo-120x30.png" /></a></p>';
        				    } else {
            ...
            wb3 += '<div class="miyn-widgets-popup-inner-contents" style="display:none;">';
    			...
    			wb3 += '<div class="miyn-widgets-popup-footer">';
    				    if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        		            ...
        		            if(b_info.powered_by_text == null) {
        				        wb3 += '<p>Driven by <a target="_blank" href="'+mainsite+'"><img class="miyn-popup-brand" src="'+protocl+cdnsite+'/images/MIYN-popup-logo-120x30.png" /></a></p>';
        				    } else {
