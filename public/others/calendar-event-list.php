...
<script>
  ...
  function loadClient() {
    gapi.client.setApiKey("AIzaSyALqxsJL3ZO-G60krmTf08Axj0jNfIZJAw");
  ...
  gapi.load("client:auth2", function() {
    gapi.auth2.init({client_id: "48673705715-o6c86pjr9g8v544sk0fnjovkmnflkofp.apps.googleusercontent.com"});
  });
</script>
