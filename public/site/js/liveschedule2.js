...
! function() {
    ...
    var _t       = MIYNLive,
        ...
        info        = [],
        protocl     = 'https://',
        mainsite    = 'seolytics.com.au',
        livesite    = 'live.seolytics.com.au',
        cdnsite     = 'cdn.seolytics.com.au',
        clientsite  = 'client.seolytics.com.au',
        apisite     = 'api.seolytics.com.au',
        appsite     = 'app.seolytics.com.au';
        			...
        			wbin1 += '<div class="miyn-widgets-popup-inner-contents '+grbox+'" style="display:none;">'; //miyn-grid-layout
        				...
        				if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        				    ...
        				    if(b_info.powered_by_text == null) {
        				        wbin1 += '<p>Driven by <a target="_blank" href="{{config('app.main_url')}}"><img class="miyn-popup-brand" src="'+protocl+cdnsite+'/images/MIYN-popup-logo-120x30.png" /></a></p>';
        				    } else {
            ...
            wbin2 += '<div class="miyn-widgets-popup-inner-contents" style="display:none;">';
    			...
    			wbin2 += '<div class="miyn-widgets-popup-footer">';
    				    if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        		            ...
        		            if(b_info.powered_by_text == null) {
        				        wbin2 += '<p>Driven by <a target="_blank" href="{{config('app.main_url')}}"><img class="miyn-popup-brand" src="'+cdnsite+'/images/MIYN-popup-logo-120x30.png" /></a></p>';
        				    } else {
            ...
            wb3 += '<div class="miyn-widgets-popup-inner-contents" style="display:none;">';
    			...
    			wb3 += '<div class="miyn-widgets-popup-footer">';
    				    if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        		            ...
        		            if(b_info.powered_by_text == null) {
        				        wb3 += '<p>Driven by <a target="_blank" href="{{config('app.main_url')}}"><img class="miyn-popup-brand" src="'+protocl+cdnsite+'/images/MIYN-popup-logo-120x30.png" /></a></p>';
        				    } else {
