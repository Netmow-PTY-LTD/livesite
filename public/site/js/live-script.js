  ...
  ! function() {
      ...
      _Mi.init = function(_) {
              ...
              //console.log(_Mi.settings);
                     ...
                     //var curr = window.location.protocol + "//" +  window.location.hostname;
                      ...
                      if(pathArray[2] == appsite || pathArray[2] == livesite) { 
                        curr_url = "";  
                        installed = 'no'; 
                      } else {
                        installed = 'yes'; 
                      ...
                      var reffreurl = document.referrer;
                      ...
                      return Promise.resolve(_)
                          .then(function() {
                              ...
                              var rr = protocl+apisite+'/api/business_info/'+_.uid+'?curr_url='+curr_url+'&reffreurl='+reffreurl+'&installed='+installed;
                              ...
                              return fetch(rr, {mode: 'cors', credentials: 'omit' })
                                  ...
                                  .then(text => {
                                    ...
                                    var infos = JSON.stringify(text);
                                      ...
                                      if(_) {
                                        var ifsubscriberexist =  document.querySelector('.subscriber');
                                    
                                        if(ifsubscriberexist) {
      ...
      _Mi.eventLoop = function ()
      {
          ...
          */
                  ...
                  //console.log("bbutton");
                      ...
                      if(_Mi.returniIframe()) {
                            ...
                            //  console.log(databutton);
                              ...
                              var wdpopbutton = document.querySelector('.miyn-widget-popup-button');
                              if(wdpopbutton) {
                                  wdpopbutton.style.display = "none";
                              }
                              ...
                              if(databutton == 'call') {
                                    if(wdpopbutton) {
                                      wdpopbutton.style.display = "flex";
                                    }
          ...
          /*var expend = document.querySelector('.expend-box-miyn');

          expend.addEventListener('click', function (event) {
              alert("Called");
          });*/
          ...
          if(div) {
           ...
           var closebuttonbox = document.querySelector('#miyn_iframe_box2 .miyn-iframe-bottom-close');
      ...
      _Mi.onTestChange = function (e) {
       ...
       _Mi.initEventList = function () {
              ...
              document.querySelectorAll(".miynreschedule").forEach(el => {
                  el.addEventListener('click',function (e) {

                    var select = $(this);
                    var id = select.attr('data-href');
              ...
              // document.querySelector('.miynreschedule').addEventListener('click', function (event) {
          //     var popID = "miyn_iframe_box";
          //     _$.show('#'+popID);
          //     _$.appendTo('#'+popID+' > .miyn-widget-iframe-contents-load', '');
          //     _f.reschedule();
          ...
          docReady(function() {
              ...
              // Listen for messages sent from the iFrame
                ...
                eventer(messageEvent,function(e) {
                    ...
                    //console.log(e.data);
                    if (parseInt(e.data.resize)> 0 ) {
                        var height = parseInt(event.data.resize);
                        var findiframe = document.getElementById('iFrame');
                        if(findiframe) {
                            findiframe.style.height = height+'px';
                        }
              ...
              window.addEventListener("message", (event) => {
                  ...
                  _Mi.urlmainheight = parseInt(event.data.height);

                  var height = screen.height;
                  var width = screen.width;

                  var fulliframebody = _Mi.iframeBodybox;

                  var headerselector = document.querySelector('#miyn_iframe_box2 .miyn-widget-popup-header');
                  var footerselector = document.querySelector('#miyn_iframe_box2 .miyn-widgets-popup-footer');
                  var boxheight = document.querySelector('#miyn_iframe_box2 .miyn-widget-iframe-contents-load');
                  ...
                  if(footerselector) {
                      footerheight = footerselector.offsetHeight;
                  }

                  if(_Mi.iframeBodybox) {

                          // //console.log(_Mi.urlmainheight);
                      var iframbodyh =  parseInt(_Mi.urlmainheight);
                      var exactheight = parseInt(height) - ((parseInt(headerheight)+parseInt(footerheight)+15));

                      //console.log('screen height - '+height);
                      //console.log('exactheight - '+exactheight);
                      var maxhet = height - exactheight;


                      _Mi.iframeBodybox.style.height = (parseInt(iframbodyh) + 20) + "px";


                      //ifrm.contentWindow.postMessage({ iframbodyh : iframbodyh },'*');

                      if(parseInt(iframbodyh) > exactheight) {
                          //boxheight.style.height = (exactheight - 250) + "px";
                          //console.log(">");
                          boxheight.style.cssText = "overflow:auto; transition:all 10s;min-height:400px; height : "+(exactheight - 250) + "px";
                      } else {
                          //console.log("<");
                          //boxheight.style.minHeight = "400px";
                          boxheight.style.cssText = "overflow:auto; transition:all 10s;min-height:400px;";
                      }

                      //console.log('iframe bod height - ' + fulliframebody);

                      //boxheight.style.overflow = "auto";
                      //boxheight.style.transition = "all 2s";

                  }

                  //console.log('iframbodyh - '+iframbodyh);
              ...
              setInterval(() => {
                  ...
                  if(isElement(_Mi.iframeBodybox)) {


                      // get reference to window inside the iframe
                      var ifrm = document.querySelector('iframe#miyn-widgets-boxs-iframe');
                      if(ifrm) {
                  ...
                  if(isElement(_Mi.iframeBody)) {

                      //console.log('Body  available');

                      var fulliframebody = _Mi.iframeBody;
                      var height = screen.height;
                      var width = screen.width;
                      //console.log("screen-"+screen.width);

                      var headerselector = document.querySelector('#miyn_iframe_box .miyn-widget-popup-header');
                      var footerselector = document.querySelector('#miyn_iframe_box .miyn-widgets-popup-footer');
                      var boxheight = document.querySelector('#miyn_iframe_box .miyn-widget-iframe-contents-load');
                      ...
                      var iframbodyh = fulliframebody;
                      var exactheight = parseInt(height) - ((parseInt(headerheight)+parseInt(footerheight)+15));

                      var maxhet = height - exactheight;
                      _Mi.iframeBody.style.height = parseInt(iframbodyh) + "px";
  ...
  var _f ={
      ...
      custom_form : function () {
              ...
              if(_Mi.returniIframe()) {
                  ...
                  document.querySelector('#miyn_iframe_box .miyn-widget-iframe-contents-load iframe').onload = function(){
                       //_Mi.iframeBody = this.contentDocument.body;
                       _Mi.iframeBody = this;
                      //console.log('iframe loaded, body is: ');
                  };
      ...
      schedule_box : function(){
              ...
              if(_Mi.returniIframe()) {
                  ...
                  document.querySelector('#miyn_iframe_box2 .miyn-widget-iframe-contents-load iframe').onload = function(){
                       //_Mi.iframeBody = this.contentDocument.body;
                       _Mi.iframeBodybox = this;
      ...
      my_account : function(){
              ...
              if(_Mi.returniIframe()) {
                   ...
                   document.querySelector('#miyn_iframe_box2 .miyn-widget-iframe-contents-load iframe').onload = function(){
                       //_Mi.iframeBody = this.contentDocument.body;
                       //_Mi.iframeBodybox = this.contentDocument.body.offsetHeight;
                       _Mi.iframeBodybox = this;
                      //console.log('iframe loaded, body is: ');
                  };
                  ...
                  document.querySelector('#miyn_iframe_box .miyn-widget-iframe-contents-load iframe').onload = function(){
                       //_Mi.iframeBody = this.contentDocument.body;
                       //_Mi.iframeBody = this.contentDocument.body.offsetHeight;
                       _Mi.iframeBody = this;
                      //console.log('iframe loaded, body is: ');
                  };
          ...
          var wbin2 = '<div id="miyn_iframe_box2" class=" miyn-widgets-iframe-box-area">';
              ...
              wbin2 += '<div class="miyn-widgets-popup-inner-contents" style="display:none;">';
                  wbin2 += '<div class="miyn-widget-popup-header">';
                      ...
                      wbin2 += '</div>';
                              //wbin2 += '<div class="expend-box-miyn"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1024 1024"><path fill="white" d="M609.408 149.376L277.76 489.6a32 32 0 0 0 0 44.672l331.648 340.352a29.12 29.12 0 0 0 41.728 0a30.592 30.592 0 0 0 0-42.752L339.264 511.936l311.872-319.872a30.592 30.592 0 0 0 0-42.688a29.12 29.12 0 0 0-41.728 0z"/></svg></div>';
                  wbin2 += '</div>';
...
class Subscriber {
    ...
    constructor(options) {
        ...
        let defaultOptions = {
            selector: ".subscriber",
            uid : "",
            externalurl : "https://api.miyn.app/api/subscription/info"
        };
        ...
        this.init = function () {
            ...
            var form = '<div class="sub-area subscribe-'+x+'">';
                    form += '<div class="sub-text ">Subscribe to newsletter</div>';
                        form += '<form id="subscribe-'+x+'" class="sub-form">';
                            form += '<div class="">';
                                form += '<input name="subemail" inp="subinput-'+x+'" class="subemail" type="email" placeholder="Your Email" required>';
                                form += '<input dad="subbubmit-'+x+'" class="sub-submit" type="button" value="Submit">';
                            form += '</div>';
                            form += '<div class="substatus">'; 
                            form += '</div>'; 
                        form += '</form>';
                    form += '</div>';
                form += '</div>';
            ...
            var inputlist = document.querySelectorAll(options.selector + ' .subemail');

            for (let i = 0; i < inputlist.length; ++i) {

                if(inputlist[i]) {
                    inputlist[i].addEventListener('keypress', function (event) {
                        if (event.key === 'Enter') {

                            
                        
                            let text = this.getAttribute("inp");
                           //console.log(text); 
                        const myArray = text.split("-");
                        let word = myArray[1];

                            var ff = document.getElementById("subscribe-"+word)
                            var formdata = new FormData(ff);

                            var data = _this.serialize(ff);
	                        //console.log(data);


                           var url = options.externalurl+'/'+options.uid;
                           ...
                           xhr.onreadystatechange = function () {
                                if (xhr.readyState === 4 && xhr.status === 200) {
                                    ...
                                    document.querySelectorAll(options.selector + ' .substatus').forEach(el => {
                                        console.log(el);
                                        //el.appendChild(form);
                                        el.innerHTML = res;
                                        ff.reset();
            ...
            var subscriptionlist = document.querySelectorAll(options.selector + ' .sub-submit');

              for (let i = 0; i < subscriptionlist.length; ++i) {

                if(subscriptionlist[i]) {

                    subscriptionlist[i].addEventListener('click', function (event) {

                        let text = this.getAttribute("dad");
                        console.log(text); 
                        const myArray = text.split("-");
                        let word = myArray[1];
