...
! function() {
    ...
    function MIYNLive(options) {}
       ...
       //var curr = window.location.protocol + "//" +  window.location.hostname;
        ...
        //_t.jsJUi();
		 ...
		 $.ajax({
            type: 'GET',
            url: protocl+apisite+'/api/business_info/'+_.uid,
            success: function (data) {
                ...
                var b_info          = config.businessinfo;
    ...
    _t.initEvent = function () {
        ...
        /* Start All Button */
        $(document).on('click', '.miynschedule  ', function(){
		...
		$(document).on('click', '.bbutton ', function(){
		    ...
		    //console.log('popupboxtype - '+popupboxtype);
...
var _f ={
    ...
    calls : function (b_info) {
        $( document ).ready(function() {
	        //console.log(config.businessinfo.b_phone);
            window.location.href = 'tel:'+config.businessinfo.b_phone;
        });
    },
    ...
    custom_form : function (b_info) {
         $( document ).ready(function() {
    		...
    		f.src = protocl + livesite + "/customform/"+config.uid;
    		f.frameBorder="0";
    ...
    schedule : function(b_info){    // _l.a()
        ...
        $( document ).ready(function() {
    		...
    		f.style.display = "block";
    		f.id="miyn-widgets-boxs-iframe";
    		f.src = protocl + livesite + "/online_newschedule/"+config.uid;
    		f.frameBorder="0";
    		$('#miyn_iframe_box .miyn-widget-iframe-contents-load').html(f);
    ...
    schedule_box : function(b_info){    // _l.a()
        ...
        $( document ).ready(function() {
    		...
    		f.style.display = "block";
    		f.id="miyn-widgets-boxs-iframe";
    		f.src = protocl + livesite + "/online_newschedule_box/"+config.uid;
    		f.frameBorder="0";
    ...
    get_a_quote : function(b_info){    // _l.a()
        ...
        $( document ).ready(function() {
    		...
    		f.style.display = "block";
    		f.id="miyn-widgets-boxs-iframe";
    		f.src = protocl + livesite + "/new-quote/"+config.uid;
    		f.frameBorder="0";
    		$('#miyn_iframe_box .miyn-widget-iframe-contents-load').html(f);
    ...
    send_file : function(b_info){    // _l.a()
        ...
        $( document ).ready(function() {
    		...
    		f.style.display = "block";
    		f.id="miyn-widgets-boxs-iframe";
    		f.src = protocl + livesite + "/new_send_file/"+config.uid;
    		f.frameBorder="0";
    		$('#miyn_iframe_box .miyn-widget-iframe-contents-load').html(f);
    		...
    		f2.src = protocl + livesite + "/new_send_file/"+config.uid;
    		f2.frameBorder="0";
    ...
    greeting : function(b_info){    // _l.a()
        ...
        $( document ).ready(function() {
    		...
    		f.style.display = "block";
    		f.id="miyn-widgets-boxs-iframe";
    		f.src = protocl + livesite + "/new-greeting/"+config.uid;
    		f.frameBorder="0";
    		$('#miyn_iframe_box .miyn-widget-iframe-contents-load').html(f);
    		...
    		f2.style.display = "block";
    		f2.id="miyn-widgets-boxs-iframe";
    		f2.src = protocl + livesite + "/new-greeting/"+config.uid;
    		f2.frameBorder="0";
    ...
    google_map : function(b_info){    // _l.a()
        ...
        $( document ).ready(function() {
    		...
    		f.style.display = "block";
    		f.id="miyn-widgets-boxs-iframe";
    		f.src = protocl + livesite + "/new-google-map/"+config.uid;
    		f.frameBorder="0";
    		$('#miyn_iframe_box .miyn-widget-iframe-contents-load').html(f);
    		...
    		f2.style.display = "block";
    		f2.id="miyn-widgets-boxs-iframe";
    		f2.src = protocl + livesite + "/new-google-map/"+config.uid;
    		f2.frameBorder="0";
    ...
    chatnow : function(b_info){    // _l.a()
        ...
        $( document ).ready(function() {
    		...
    		f.style.display = "block";
    		f.id="miyn-widgets-boxs-iframe";
    		f.src = protocl + livesite + "/chatnow/"+config.uid;
    		f.frameBorder="0";
    		$('#miyn_iframe_box .miyn-widget-iframe-contents-load').html(f);
    		...
    		f2.style.display = "block";
    		f2.id="miyn-widgets-boxs-iframe";
    		f2.src = protocl + livesite + "/chatnow/"+config.uid;
    		f2.frameBorder="0";
    ...
    my_account : function(b_info){    // _l.a()
        ...
        $( document ).ready(function() {
    		...
    		f.style.display = "block";
    		f.id="miyn-widgets-boxs-iframe";
    		f.src = protocl + livesite + "/client_get_newcode/"+config.uid;
    		f.frameBorder="0";
    		$('#miyn_iframe_box .miyn-widget-iframe-contents-load').html(f);
    		...
    		f2.style.display = "block";
    		f2.id="miyn-widgets-boxs-iframe";
    		f2.src = protocl + livesite + "/client_get_newcode/"+config.uid;
    		f2.frameBorder="0";
...
var _l ={
            ...
            var wb1 = '<div id="widget_button_option_1" class="miyn-widget-buttons-area">';
    		    ...
    		    for (var i = 0; i < b_info.liveaction.length; i++) {
    		        if(b_info.liveaction[i].view_status == 'true') {
        			    wb1 += '<li><a class=" rbutton '+prefix+b_info.liveaction[i].calltoaction+' " dtbutton="'+b_info.liveaction[i].calltoaction+'" href="#"><img src="https://'+livesite+'/images/rounded/'+b_info.liveaction[i].rounded_button_image+'" alt="schedule-icon.png"/><span>'+b_info.liveaction[i].calltoaction_text+'</span></a></li>';
    		        }
    		    }
    		    
    		   // if(config.uid == "13022022iao0k4ly7hp3rsu")  {
    		   //     wb1 += '<li><a class=" rbutton '+prefix+'chatnow" dtbutton="chatnow" href="#"><img src="https://'+livesite+'/images/rounded/chat-now.png" alt="schedule-icon.png"/><span>Chat Now</span></a></li>';
    		   // }
    		    
    		    wb1 += '<li><a class=" rbutton '+prefix+'acc" dtbutton="acc" href="#miyn_iframe_box"><img src="https://'+livesite+'/images/rounded/my-acc.png" alt="schedule-icon.png"/><span>My Account</span></a></li>';
	    ...
	    console.log('grbox:'+grbox);
          ...
          var img = protocl + livesite +'/newdesign/';
              ...
              var wbin1 = '<div id="popup-services" class="miyn-widget-popup-content-area miyn-popup-services-area">';
        			...
        			wbin1 += '<div class="miyn-widgets-popup-inner-contents '+grbox+'">'; //miyn-grid-layout
        				...
        				wbin1 += '<div class="miyn-widget-popup-services">';
        					...
        					wbin1 += '<ul>';
            					...
            					for (var i = 0; i < b_info.liveaction.length; i++) {
            					    if(b_info.liveaction[i].view_status == 'true') {
                        		        //	wbin1 += '<li><a class=" '+prefix+b_info.liveaction[i].calltoaction+' " href="#miyn_iframe_box2"><img src="https://'+livesite+'/images/rounded/'+b_info.liveaction[i].rounded_button_image+'" alt="schedule-icon.png"/><span>'+b_info.liveaction[i].calltoaction_text+'</span></a></li>';
            					        wbin1 += '<li><a class=" bbutton '+prefix+b_info.liveaction[i].calltoaction+' " dtbutton="'+b_info.liveaction[i].calltoaction+'" dtpopuptype="'+b_info.livestyle.button_bottom_open_box+'" href="#"><span><img src="https://'+livesite+'/images/rounded/'+b_info.liveaction[i].rounded_button_image+'" alt="schedule-icon.png"/></span>'+b_info.liveaction[i].calltoaction_text+'</a></li>';
            					    }   
            					}
            					//if(config.uid == "13022022iao0k4ly7hp3rsu")  {
            					//    wbin1 += '<li><a class=" bbutton '+prefix+'chatnow" dtbutton="chatnow" dtpopuptype="'+b_info.livestyle.button_bottom_open_box+'" href="#"><span><img src="https://'+livesite+'/images/rounded/chat-now.png" alt="schedule-icon.png"/></span>Chat Now</a></li>';
            					//}
            					wbin1 += '<li><a class=" bbutton '+prefix+'acc" dtbutton="acc" dtpopuptype="'+b_info.livestyle.button_bottom_open_box+'" href="#"><span><img src="https://'+livesite+'/images/rounded/my-acc.png" alt="schedule-icon.png"/></span>My Account</a></li>';
        				...
        				if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        		            wbin1 += '<p >Powered by <span style="color:'+b_info.livestyle.action_background_color+'">'+b_info.business_name+'</span></p>';
        		        } else {
        		            wbin1 += '<p>Driven by <a target="_blank" href="{{config('app.main_url')}}"><img class="miyn-popup-brand" src="https://cdn.miyn.app/images/MIYN-popup-logo-120x30.png" /></a></p>';
        		        }  
    ...
    d : function(b_info) {
       ...
       var img = protocl + livesite +'/newdesign/';
        ...
        var wbin2 = '<div id="miyn_iframe_box2" class=" miyn-widgets-iframe-box-area">';
            ...
            wbin2 += '<div class="miyn-widgets-popup-inner-contents">';
    			...
    			wbin2 += '<div class="miyn-widgets-popup-footer">';
    				    if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        		            wbin2 += '<p >Powered by <span style="color:'+b_info.livestyle.action_background_color+'">'+b_info.business_name+'</span></p>';
        		        } else {
        		            wbin2 += '<p>Driven by <a target="_blank" href="{{config('app.main_url')}}"><img class="miyn-popup-brand" src="https://cdn.miyn.app/images/MIYN-popup-logo-120x30.png" /></a></p>';
        		        }  
    			wbin2 += '</div>';
            wbin2 += '</div>';
        wbin2 += '</div>';
    ...
    e : function(b_info) {  // _l.e()
       ...
       var wb3 = '<div id="miyn_iframe_box" class="miyn-widget-popup-content-area miyn-widgets-iframe-box-area">';
            wb3 += '<div class="miyn-widgets-popup-inner-contents">';
    			wb3 += '<div class="miyn-popup-close-button"></div>';
    			wb3 += '<div class="miyn-widget-popup-header">';
    				wb3 += '<div class="miyn-widget-popup-logo">';
    					wb3 += '<img src="'+protocl+appsite+'/images/widget_image/'+b_info.livestyle.label_partial_image+'" alt="logo"/>';
    				wb3 += '</div>';
    			...
    			wb3 += '<div class="miyn-widgets-popup-footer">';
    				    if((b_info.remove_all_miyn_powered == 'true') && ((b_info.package_id == '3') || (b_info.package_id == '5'))) {
        		            wb3 += '<p >Powered by <span style="color:'+b_info.livestyle.action_background_color+'">'+b_info.business_name+'</span></p>';
        		        } else {
        		            wb3 += '<p>Driven by <a target="_blank" href="{{config('app.main_url')}}"><img class="miyn-popup-brand" src="https://cdn.miyn.app/images/MIYN-popup-logo-120x30.png" /></a></p>';
        		        }
    			wb3 += '</div>';
            wb3 += '</div>';
        wb3 += '</div>';
